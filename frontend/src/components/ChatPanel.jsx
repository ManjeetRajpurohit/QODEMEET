...
const ChatPanel = ({
  ...
  return (
    <>
      <div className="border-t border-white/10 px-4 py-3 text-white font-medium">
        Chat
      </div>
              ...
              >
                <div>
                  ...
                  <div
                    className={
                      isOwnMessage
                        ? "bg-gradient-to-r from-violet-500 to-fuchsia-500 p-3 rounded-xl text-white max-w-[220px] break-words"
                        : "bg-[#0B1220] p-3 rounded-xl text-white max-w-[220px] break-words"
                    }
                  >
                    {msg.message}
                  </div>
